...
export const FeatureRow = ({
  ...
  return (
    ...
    >
      ...
      <div style={{ order: isMobile ? 2 : reverse ? 1 : 2, position: 'relative' }}>{visual}</div>
    </div>
  );
};
...
export const SectionShell = ({
  ...
  <section
    id={id}
    style={{ padding: 'clamp(4rem, 8vw, 7rem) clamp(1.25rem, 4vw, 2rem) clamp(3.5rem, 7vw, 6rem)' }}
  >
...
export const FeatureChain = () => {
  const items = [blockById('circle'), blockById('ripple')].filter(
      ...
      <div key={i}>
        ...
        >
          ...
          <span
            style={{
              ...
              color: row.animated ? SHADE.gold : SHADE.cream,
            }}
          >
            {row.v}
          </span>
        ...
        <div style={{ position: 'relative', height: 18 }}>
          ...
          <div
            style={{
              position: 'absolute',
              left: `calc(${row.value * 100}% - 8px)`,
              top: 1,
              width: 16,
              height: 16,
              background: '#15171b',
              border: `1.5px solid ${row.animated ? SHADE.gold : 'rgba(232,226,212,0.5)'}`,
              borderRadius: 3,
            }}
          >
            <span
